...
namespace WebAPI.Migrations
{
    ...
    [Migration("20220517074621_delete-required-adress-partner")]
    partial class deleterequiredadresspartner
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebAPI.Models.BS_Framework", b =>
                {
            ...
            modelBuilder.Entity("WebAPI.Models.BS_Language", b =>
                {
            ...
            modelBuilder.Entity("WebAPI.Models.BS_Level", b =>
                {
            ...
            modelBuilder.Entity("WebAPI.Models.BS_PartnerInfo", b =>
                {
            ...
            modelBuilder.Entity("WebAPI.Models.BS_Recruitment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("DateOnBroad")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("WebAPI.Models.BS_UserOnboard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI.Models.BS_UserSalaries", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("WebAPI.Models.BS_Position", b =>
                {
                    b.HasOne("WebAPI.Models.BS_UserInfo", "UserInfo")
                        .WithMany()
            ...
            modelBuilder.Entity("WebAPI.Models.BS_Project", b =>
                {
                    b.HasOne("WebAPI.Models.BS_PartnerInfo", "Customer")
                        .WithMany("CustomerProjects")
                        .HasForeignKey("CustomerId");

                    b.HasOne("WebAPI.Models.BS_PartnerInfo", "Partner")
            ...
            modelBuilder.Entity("WebAPI.Models.BS_Recruitment", b =>
                {
                    b.HasOne("WebAPI.Models.BS_Framework", "Framework")
                        .WithMany("Recruitments")
                        .HasForeignKey("FrameworkId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebAPI.Models.BS_Language", "Language")
                        .WithMany("Recruitments")
                        .HasForeignKey("LanguageId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebAPI.Models.BS_Level", "Level")
                        .WithMany("Recruitments")
